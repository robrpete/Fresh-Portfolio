      ...
      <div class="container px-5 py-8 mx-auto flex flex-col items-center space-y-4">
        <span class="inline-flex sm:mx-auto sm:mt-0 mt-4 justify-center">
          ...
          <a
            ...
            href="https://github.com/robrpete"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <a href="https://fresh.deno.dev">
          ...
          >
            ...
            <path
              d="M27.1 12.475c4.45-2.923 9.766-4.147 11.94-2.255 3.335 2.905-7.065 9.478-10.965 11.03-4.225 1.682-1.95 5.525-4.225 5.525-1.95 0-1.625-2.6-3.369-5.037-1.03-1.44 1.523-5.916 6.619-9.263z"
              fill="#fff"
              stroke="#FDCF2B"
              stroke-width=".65"
            >
